...
public class CaregiverForgotPasswordActivity extends BaseActivity {
...
/*
                                Toast.makeText(CaregiverForgotPasswordActivity.this, "Password Not Change", Toast.LENGTH_SHORT).show();
*/
                            }
                        }else{
                    ...
                    if (BtnChangeSubmitPassId.getText().equals("Submit")) {
        ...
        new JSONParser(this).parseVollyStringRequest(Const.URL.Client_ChangePasword_Url, 1, getParams1(), new Helper() {
            ...
            public void backResponse(String response) {
                try {
                    ...
                    if (status == 200) {
/*
                        Toast.makeText(CaregiverForgotPasswordActivity.this, " Change Password sucessfully", Toast.LENGTH_SHORT).show();
*/

                        S.I_clear(CaregiverForgotPasswordActivity.this,CareGiverEnterMobileActivity.class,null);

                    } else {
/*
                        Toast.makeText(CaregiverForgotPasswordActivity.this, "Password Not Match..", Toast.LENGTH_SHORT).show();
*/
                    }
        ...
        new JSONParser(this).parseVollyStringRequest(Const.URL.Client_MatchOtp, 1, getParam(), new Helper() {
            ...
            public void backResponse(String response) {
                ...
                try {
                    ...
                    if (status == 200) {
/*
                        Toast.makeText(CaregiverForgotPasswordActivity.this, "sucessfully", Toast.LENGTH_SHORT).show();
*/
...
/*
                        Toast.makeText(CaregiverForgotPasswordActivity.this, "Otp Not Match..", Toast.LENGTH_SHORT).show();
*/
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
...
/*
                        Toast.makeText(CaregiverForgotPasswordActivity.this, "Not Genrated Otp", Toast.LENGTH_SHORT).show();
*/
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
